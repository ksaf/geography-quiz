package com.orestis.velen.quiz.outlines;
...
import static com.orestis.velen.quiz.questions.GameType.TYPE_OUTLINES;
...
public class MainActivity extends AppCompatActivity implements LoadingBarStateListener, AnswerGivenListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionTextHandler = new QuestionTextHandler(face, (TextView) findViewById(R.id.questionText),
                questionHandler, questionAnnouncement, TYPE_OUTLINES, this);

        questionHandler.init(difficulty, TYPE_OUTLINES, LEVEL_QUESTION_SAMPLE);
        ...
        bonusManager = new StreakBonusManager(GEOGRAPHY, difficulty, TYPE_OUTLINES, bonusDisplayHandler);
